...
- [NetworkMiner Traffic Analysis]([https://github.com/JudeVdByl/NetworkMiner-Traffic-Analysis](https://github.com/JudeVdByl/Network-Traffic-Analysis-Project)) - Forensic analysis of network traffic using NetworkMiner to extract crucial data like IP addresses and login credentials.
